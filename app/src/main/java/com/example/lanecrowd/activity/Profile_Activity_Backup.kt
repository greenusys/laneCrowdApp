...
class Profile_Activity_Backup : RuntimePermissionsActivity(), KodeinAware {
...
/*
    ...
    private fun showProfileBottomSheet(from: String) {
        var sheetDialog = BottomSheetDialog(this@Profile_Activity_Backup)
        val sheetView =
            LayoutInflater.from(this@Profile_Activity_Backup).inflate(R.layout.profilebottomsheet, null)
    ...
    private fun checkPermissions(from: String) {
        ...
        if (ContextCompat.checkSelfPermission(
                this@Profile_Activity_Backup,
                Manifest.permission.READ_EXTERNAL_STORAGE
            ) != PackageManager.PERMISSION_GRANTED
        ) {
            super@Profile_Activity_Backup.requestAppPermissions(
                arrayOf(
                    Manifest.permission.READ_EXTERNAL_STORAGE,
